...
PATH_='ckpt/ImageNet/ly8/deit_small/ckpt/model_epoch20.pth'
WORK_DIR=${WORK_DIR}$(echo ${PATH_})
export CUDA_VISIBLE_DEVICES=${GPU_ID}

python ./tools_cam/test_cam.py --config_file configs/ILSVRC/${NET}_tscam_${NET_SCALE}_patch16_${SIZE}.yaml --resume ${WORK_DIR} TEST.SAVE_BOXED_IMAGE True MODEL.CAM_THR 0.1