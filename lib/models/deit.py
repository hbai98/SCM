...
__all__ = [
    'deit_tscam_tiny_patch16_224', 'deit_tscam_small_patch16_224', 'deit_tscam_base_patch16_224', 'vit_tscam_base_patch16_224'
]
...
def deit_tscam_base_patch16_224(pretrained=False, **kwargs):
    ...
    return model
@register_model
def vit_tscam_small_patch16_224(pretrained=False, **kwargs):
    model = TSCAM(
